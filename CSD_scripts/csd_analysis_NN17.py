...
est_xyz[1]+=cory
est_xyz[2]+=corz
indx = (est_xyz[2]<2.5)*(est_xyz[0]>-1.5)*(est_xyz[1]>-2)
indxt = (est_xyz[2]>2.5)*(est_xyz[0]<-1.5)*(est_xyz[0]>-2.5)*(est_xyz[1]<0)
...
# mlab.points3d(est_xyz[0,inds], est_xyz[1,inds], est_xyz[2,inds], scale_mode='none',
                # scale_factor=0.08, color = (.1, .2, .5))
mlab.points3d(est_xyz[0], est_xyz[1], est_xyz[2], scale_mode='none', 
                scale_factor=0.06, color = (.1, .2, .5))
