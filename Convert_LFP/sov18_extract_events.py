...
datadir = 'H:/SOVy/SOV18/'
sovs = ['02wasy_', '03wasy_', '04wasy_']
resamp = 4
...
for sov in sovs:
    ...
    py.ylabel('channels')
    py.subplot(212)
    py.title('Correlation sov18:: '+savename)
    ...
    py.savefig('sov18_'+savename+'_load')
    scipy.io.savemat('./mats/sov18_'+savename+'.mat',
