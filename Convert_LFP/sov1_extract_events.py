...
for i in range(100):
    ...
    trials_b[14:,i] = sig_B2[6:14,int(t1b*Fs-back-shf):int(t1b*Fs+forward-shf)]
...
# trials_b = np.delete(trials_b, [3,6],axis=0)
# trials_t = np.delete(trials_t, [3,6],axis=0)
# cor_b = np.delete(cor_b, [3,6],axis=0)
# cor_t = np.delete(cor_t, [3,6],axis=0)
#%%
